...
class lora_sdr_lora_rx(gr.hier_block2):
    def __init__(self, center_freq=868100000, bw=125000, cr=1, has_crc=True, impl_head=False, pay_len=255, samp_rate=250000, sf=7,sync_word=[0x12], soft_decoding=False, ldro_mode=2, print_rx=[True,True], legacy_sf56=False):
        ...
        self.lora_sdr_frame_sync_0 = lora_sdr.frame_sync(center_freq, bw, sf, impl_head, sync_word,int(samp_rate/bw),8,legacy_sf56)
