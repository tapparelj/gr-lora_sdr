...
/* BINDTOOL_HEADER_FILE_HASH(964a2a6436946fb9bee97bce546b1ced)                     */
/***********************************************************************************/
...
void bind_frame_sync(py::module& m)
{
    ...
    py::class_<frame_sync, gr::block, gr::basic_block, std::shared_ptr<frame_sync>>(
        m, "frame_sync", D(frame_sync))
