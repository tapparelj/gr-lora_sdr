...
class ref_rx_generate(gr.top_block):
    ...
    def __init__(self, sf, cr):
        ...
        output_file_path = "/home/yujwu/Documents/gr-lora_sdr/python/lora_sdr/qa_ref/qa_ref_rx/ref_rx_sf{}_cr{}.bin".format(self.sf, self.cr)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, output_file_path, False)
        ...
        self.connect((self.lora_sdr_crc_verif_0, 0), (self.blocks_file_sink_0_0, 0))
