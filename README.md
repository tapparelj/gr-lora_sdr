...
### From conda
Thanks to Ryan Volz this OOT module can also directly be installed as a Conda package. Not that gnuradio will also be installed in the conda environment.
