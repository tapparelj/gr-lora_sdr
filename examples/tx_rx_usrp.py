...
class tx_rx_usrp(gr.top_block):
    ...
    def __init__(self):
        ...
        self.lora_sdr_modulate_0 = lora_sdr.modulate(sf, samp_rate_tx, bw, [0x12], (int(20*2**sf*samp_rate_tx/bw)),8, False)
        self.lora_sdr_modulate_0.set_min_output_buffer(10000000)
        self.lora_sdr_interleaver_0 = lora_sdr.interleaver(cr, sf, 2, 125000, False)
        ...
        self.lora_sdr_frame_sync_0 = lora_sdr.frame_sync(int(center_freq), bw, sf, impl_head, [18], (int(samp_rate_rx/bw)),8, False)
