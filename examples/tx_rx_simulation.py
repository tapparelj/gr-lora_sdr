...
class tx_rx_simulation(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_vector_sink_x_1 = blocks.vector_sink_b(1, 1024)
        self.blocks_file_source_0_1 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/yujwu/Documents/gr-lora_sdr/python/lora_sdr/qa_ref/qa_ref_tx/ref_tx_sf7_cr2.bin', False, 0, 0)
        ...
        self.connect((self.blocks_file_source_0_1, 0), (self.lora_sdr_frame_sync_0, 0))
        self.connect((self.lora_sdr_crc_verif_0, 0), (self.blocks_vector_sink_x_1, 0))
