...
// Uncomment this line (and comment the next one) to print the debug messages
// #define debug_print(message,name,color) std::cout << color << "["<<name<<"] "<< message << RESET << std::endl;
#define debug_print(message,name,color);
