 ...
 * @return uint32_t
 */
uint32_t get_symbol_val(const gr_complex *samples,
                                         gr_complex *ref_chirp, uint32_t m_number_of_bins, uint32_t m_samples_per_symbol, kiss_fft_cpx *cx_in, kiss_fft_cpx *cx_out);
 ...
 */
void build_ref_chirps(gr_complex *upchirp, gr_complex *downchirp,
                             uint8_t sf);
