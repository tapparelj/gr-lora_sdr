  ...
  namespace lora_sdr {
    ...
    class frame_sync_impl : public frame_sync
    {
     private:
         ...
         bool m_ldro; ///< use low datarate optimisation mode
         ...
         uint8_t n_up_trig;          ///< number of repeating symbol to consider as a preamble
         ...
         std::vector<int> preamb_up_vals;          ///< demodulated bins in preamble
