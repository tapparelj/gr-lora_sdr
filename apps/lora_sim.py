...
class lora_sim(gr.top_block):
    ...
    def __init__(self):
        ...
        self.interp_fir_filter_xxx_0.set_min_output_buffer(4096)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.lora_sdr_crc_verif_0, 'ctrl_out'), (self.lora_sdr_data_source_sim_0, 'ctrl_in'))
        self.msg_connect((self.lora_sdr_crc_verif_0, 'ctrl_out'), (self.lora_sdr_frame_sync_0, 'ctrl_in'))
        ...
        self.msg_connect((self.lora_sdr_frame_sync_0, 'ctrl_out'), (self.lora_sdr_data_source_sim_0, 'ctrl_in'))
