...
class sim_lor(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.msg_connect((self.lora_sdr_data_source_0_1_0, 'msg'), (self.blocks_message_debug_1_0_0, 'print'))
        ...
        self.msg_connect((self.lora_sdr_err_measures_0, 'err'), (self.blocks_message_debug_1, 'print'))
        self.msg_connect((self.lora_sdr_frame_sync_0, 'new_frame'), (self.blocks_message_debug_1_0, 'print'))
