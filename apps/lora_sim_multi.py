...
class lora_sim_multi(gr.top_block):
    ...
    def __init__(self):
        ...
        self.lora_sdr_hier_rx_0_1_0_0_1_0_0 = lora_sdr.hier_rx(samp_rate, bw, sf2, impl_head, cr, pay_len, has_crc)
        self.lora_sdr_hier_rx_0_1_0_0_1_0 = lora_sdr.hier_rx(samp_rate, bw, 7, impl_head, cr, pay_len, has_crc)
        self.interp_fir_filter_xxx_0_0_1 = filter.interp_fir_filter_ccf(4, (-0.128616616593872,-0.212206590789194,-0.180063263231421,3.89817183251938e-17,0.300105438719035,0.636619772367581,0.900316316157106,1,0.900316316157106,0.636619772367581,0.300105438719035,3.89817183251938e-17,-0.180063263231421,-0.212206590789194,-0.128616616593872))
        self.interp_fir_filter_xxx_0_0_1.declare_sample_delay(0)
        self.interp_fir_filter_xxx_0_0_1.set_min_output_buffer(8192)
        ...
        self.connect((self.blocks_throttle_0_0, 0), (self.interp_fir_filter_xxx_0_0_1, 0))
        self.connect((self.interp_fir_filter_xxx_0_0, 0), (self.lora_sdr_hier_rx_0_1_0_0_1_0, 0))
        self.connect((self.interp_fir_filter_xxx_0_0_1, 0), (self.lora_sdr_hier_rx_0_1_0_0_1_0_0, 0))
