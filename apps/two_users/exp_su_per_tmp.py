...
# Generated: Sun Jan 24 11:09:21 2021
##################################################
...
class mu_tx_rx(gr.top_block):
    ...
    def __init__(self):
        ...
        self.sto = sto = [0,32.25]
        self.snr_thres = snr_thres = -19
        self.samp_rate = samp_rate = bw
        self.rx_gain = rx_gain = 10
        self.rand_sto = rand_sto = [False,False]
        self.power = power = [-16,-13]
        self.pay_len = pay_len = 32
        self.os_factor_rx = os_factor_rx = 8
        self.n_frame = n_frame = 5000
        self.measurement_folder = measurement_folder = "/home/jtappare/Documents/lora_gnu_radio_prototype/gr-lora_sdr/matlab/measurements/exp_MU_sf8_32.25_0.25_ku5_os8_pl32_24-01-21"
        ...
        self.blocks_file_sink_3_0 = blocks.file_sink(gr.sizeof_short*1, measurement_folder + "/mu_source_s2_-16_3.txt", False)
        self.blocks_file_sink_3_0.set_unbuffered(False)
        self.blocks_file_sink_3 = blocks.file_sink(gr.sizeof_short*1, measurement_folder + "/mu_source_s1_-16_3.txt", False)
        self.blocks_file_sink_3.set_unbuffered(False)
        self.blocks_file_sink_1_0_1 = blocks.file_sink(gr.sizeof_int*1, measurement_folder + "/sync_state_-16_3.txt", False)
        self.blocks_file_sink_1_0_1.set_unbuffered(False)
        self.blocks_file_sink_1_0_0 = blocks.file_sink(gr.sizeof_float*1, measurement_folder + "/mu_snr_-16_3.txt", False)
        self.blocks_file_sink_1_0_0.set_unbuffered(False)
        self.blocks_file_sink_1_0 = blocks.file_sink(gr.sizeof_short*1, measurement_folder + "/mu_demod_s2_-16_3.txt", False)
        self.blocks_file_sink_1_0.set_unbuffered(False)
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_short*1, measurement_folder + "/mu_demod_s1_-16_3.txt", False)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate*os_factor_tx, analog.GR_SIN_WAVE, -9.4*samp_rate/2**sf, 10**(-4.2/20.0), 0)
    ...
    def set_measurement_folder(self, measurement_folder):
        ...
        self.blocks_file_sink_3_0.open(self.measurement_folder + "/mu_source_s2_-16_3.txt")
        self.blocks_file_sink_3.open(self.measurement_folder + "/mu_source_s1_-16_3.txt")
        self.blocks_file_sink_1_0_1.open(self.measurement_folder + "/sync_state_-16_3.txt")
        self.blocks_file_sink_1_0_0.open(self.measurement_folder + "/mu_snr_-16_3.txt")
        self.blocks_file_sink_1_0.open(self.measurement_folder + "/mu_demod_s2_-16_3.txt")
        self.blocks_file_sink_1.open(self.measurement_folder + "/mu_demod_s1_-16_3.txt")
