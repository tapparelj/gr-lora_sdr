...
# Generated: Mon Dec 14 10:36:41 2020
##################################################
...
class mu_tx_rx_coh(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Mu Tx Rx Coh")
        ...
        self.delay = delay = int(200*os_factor_tx*2**sf)
        ...
        (self.uhd_usrp_source_0).set_min_output_buffer(204800)
        ...
        (self.lora_sdr_signal_detector_0).set_min_output_buffer(819200)
        ...
        (self.lora_sdr_mu_detection_0).set_min_output_buffer(204800)
        self.lora_sdr_mu_demod_0 = lora_sdr.mu_demod(sf, 1)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate*os_factor_tx, analog.GR_SIN_WAVE, -4.8*samp_rate/2**sf, 10**(-4.2/20.0), 0)
    ...
    def set_sf(self, sf):
        self.sf = sf
        self.set_delay(int(200*self.os_factor_tx*2**self.sf))
        ...
        self.analog_sig_source_x_0.set_frequency(-4.8*self.samp_rate/2**self.sf)
...
def main(top_block_cls=mu_tx_rx_coh, options=None):
