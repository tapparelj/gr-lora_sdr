...
class cpp_export_test(gr.top_block):
    ...
    def __init__(self):
        ...
        self.lora_sdr_hier_rx_0 = lora_sdr.hier_rx(samp_rate, bw, sf, impl_head, cr, pay_len, has_crc, True)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_throttle_0, 0), (self.lora_sdr_hier_rx_0, 0))
...
def main(top_block_cls=cpp_export_test, options=None):
    tb = top_block_cls()
