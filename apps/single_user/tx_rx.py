...
class tx_rx(gr.top_block):
    ...
    def __init__(self):
        ...
        self.lora_sdr_modulate_0 = lora_sdr.modulate(sf, samp_rate, bw, sync_words,False)
        ...
        self.blocks_tag_debug_1 = blocks.tag_debug(gr.sizeof_char*1, 'work_done', "work_done")
        ...
        self.connect((self.lora_sdr_header_0, 0), (self.blocks_tag_debug_1, 0))
