...
class tx_rx_simulation(gr.top_block):
    ...
    def __init__(self,tx_payload_file, rx_payload_file, rx_crc_file, impl_head=False, soft_decoding=False, SNRdB=0,samp_rate=250000, bw=125000, sf=7, cr=1, pay_len=32, CFO=0, SFO=0, ldro=False):
        ...
        self.channels_channel_model_0 = channels.channel_model(
            ...
            frequency_offset = CFO/2**sf/samp_rate*bw,
            epsilon=1.0,
            taps=[1.0 + 0.0j],
            noise_seed=0,
            block_tags=True)
